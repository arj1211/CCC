...
//	//	v(string) theWord;
//	//	for (string w : words)
//	//		if (count(words.begin(), words.end(), w) == k)
//	//		{
//	//			if (flag && count(theWord.begin(), theWord.end(), w) < 1)//if first tiem seeing this word but same k
//	//			{
//	//				print(w)
//	//					continue;
//	//			}
//	//			else if (count(theWord.begin(), theWord.end(), w)) continue;//if seen this word before, ignore
//
//	//			theWord.pbb(w);
//	//			flag = true;
//	//			if (k == 1)
